import { Zap, ShieldAlert, ArrowRight, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 sm:p-8 min-h-[500px] h-auto lg:h-[calc(100vh-16rem)]">
      ...
      <div className="text-center mb-12">
        <h2 className="text-4xl font-black mb-4 uppercase tracking-widest text-[#141414]">Công Cụ Phụ Trợ</h2>
        <p className="text-[#141414]/70 max-w-xl mx-auto font-medium">Truy cập nhanh các ứng dụng phục vụ quản lý trạm biến áp và xử lý vi phạm đấu tắt.</p>
      </div>
        ...
        >
          ...
          <div className="p-8">
            <div className="flex justify-between items-start mb-2">
              ...
              <ExternalLink className="w-5 h-5 text-[#141414]/40 group-hover:text-[#141414] transition-colors" />
            </div>
            ...
            <div className="inline-flex items-center gap-2 font-bold text-[#141414] group-hover:gap-4 transition-all uppercase text-sm tracking-wider">
               Truy cập ứng dụng <ArrowRight className="w-4 h-4" />
            </div>
          </div>
        </a>
