...
appContent = appContent.replace(/2026\.09\.25/g, '2026.09.26');
fs.writeFileSync('src/App.tsx', appContent, 'utf8');

let loginContent = fs.readFileSync('src/components/Login.tsx', 'utf8');
loginContent = loginContent.replace(/2026\.09\.25/g, '2026.09.26');
...
configContent = configContent.replace(/2026\.09\.25/g, '2026.09.26');
